 ...
 *
 * <p>Locale 优先从 {@link LocaleContextHolder} 获取（由 Spring MVC 的 LocaleResolver 在请求进入时设置，对应
 * Accept-Language 请求头）， 非 Web 线程回退到 JVM 默认 Locale。
 *
 * <p>由 {@code EngineCoreAutoConfiguration} 注册为 Bean，业务模块直接注入 {@link MessageResolver} 接口即可，无需感知
 * Spring 实现细节 @Author: Noah Zhou
 */
